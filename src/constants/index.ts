...
const IPAD_PRO_NAME: string = "Apple iPad Pro 11 - £300";
...
const SAMSUNG_TAB_NAME: string = "Samsung Galaxy Tab S6 - £300";
...
const MICROSOFT_PRO_NAME: string = "Microsoft Surface Pro - £300";
